...
namespace MapeoINEGI
{
	class MainClass
	{
		public static void Main (string[] args)
		{
			...
			string geojsonModiPath = @"/Users/eherrador/Desktop/GFK/GeoJSON/Modificados/";
			string geojsonReportePath = @"/Users/eherrador/Desktop/GFK/GeoJSON/Modificados/Reportes/";
			...
			//string geojsonFileName = @"HGOUrbAgeb.json";
			...
			string metadatosFile = @"/Users/eherrador/Desktop/GFK/GeoJSON/Metadatos/Descripciones_Abreviado.txt";
